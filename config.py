...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "7831049231:AAFx7-kElTlxanmvRRWRZfz4GyFDFpZBQag") 
    BOT_OWNER_ID = [int(id) for id in environ.get("BOT_OWNER_ID", '5437233066').split()]
    BOT_SESSION = environ.get("BOT_SESSION", "slowf3") 
    ...
    DATABASE_NAME = environ.get("DATABASE_NAME", "slowf3")
    
    LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002642197109'))
